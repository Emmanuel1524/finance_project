...
1. **Portões** (eliminatórios): integridade e revisão de overfitting limpas ([07 §5](07_agent_protocol.md)); não frágil ([§11](#11-robustez-temporal-e-concentração-de-pnl)); amostra mínima; critério absoluto (expectância positiva após custos), pois vencer o V0 é um piso baixo.
