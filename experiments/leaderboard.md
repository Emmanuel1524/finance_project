...
**Status (RUN-0001, 2026-09-19): vazio — nenhum candidato passou nos portões D3** (melhor frontier não-aprovado: RUN-0001/EXP-0005). **RUN-0002 e RUN-0003:** continua vazio; fronteira não-aprovada: RUN-0002/EXP-0012 (falha top-5 = 72% e concentração mensal; data-informed).
...
| 2026-09-19 | RUN-0003/EXP-0017..0021 | NÃO ENTROU | — | Nenhum passa nos portões (todos com expectância ≤ 0). Ver `RUN-0003/run_report.md`. |
